        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 border border-gray-300 rounded-md focus:outline-2 focus:outline-offset-2 focus:outline-blue-600 focus:border-blue-500 text-sm transition-colors"
            />
          </div>
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2.5 border border-gray-300 rounded-md focus:outline-2 focus:outline-offset-2 focus:outline-blue-600 focus:border-blue-500 text-sm transition-colors resize-none"
            />
          </div>
