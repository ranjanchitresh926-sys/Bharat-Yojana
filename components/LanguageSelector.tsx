          ...
          <div className="bg-white p-8 rounded-lg shadow-lg max-w-lg w-full mx-4 transform transition-transform">
            <div className="flex justify-between items-center mb-6 border-b pb-4">
              ...
              <button 
                ...
                className="text-gray-400 hover:text-gray-800 text-2xl font-bold w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-100 transition-colors focus:outline-2 focus:outline-offset-2 focus:outline-blue-600"
              >
                &times;
              </button>
            </div>
